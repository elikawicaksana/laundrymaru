...
<head>
    <?php
        ...
        $query = mysqli_query($conn, "SELECT tb_produk.*, nama_outlet FROM db_laundry.tb_produk
                                      LEFT JOIN db_laundry.tb_outlet ON tb_produk.id_outlet=tb_outlet.id_outlet 
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <p class="text-muted">Now you are viewing the package page</p>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title vertical-center">Packages Listing</h3>
                                    <a href="input-produk.php"><button class="btn btn-md btn-light float-right"><i class="fa-solid fa-arrow-up-right-from-square"></i> Add new package</button></a>
                                </div>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                while($fetch=mysqli_fetch_array($query)){ 
                                                    ...
                                                    "<tr>
                                                        <td>".$i."</td>
                                                        <td>".$fetch['nama_produk']."</td>
                                                        <td>".$fetch['nama_outlet']."</td>
                                                        <td>".$fetch['jenis_produk']."</td>
                                                        <td>".formatUang($fetch['harga'])."</td>
                                                        <td>
                                                            <a href='edit-produk.php?id_produk=".$fetch['id_produk']."'><button class='btn btn-xs btn-info' type='button'><i class='fa fa-edit'></i> Edit</button></a> |
                                                            <button class='btn btn-xs btn-danger' type='button' id='btnDel' data-id='".$fetch['id_produk']."'><i class='fa-regular fa-trash-can'></i> Hapus</button>
                                                        </td>
                                                    </tr>
                                                    ";
                                                    $i++; 
