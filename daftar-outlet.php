...
<head>
    <?php
        ...
        $query = mysqli_query($conn, "SELECT * FROM db_laundry.tb_outlet")OR die(mysqli_error($conn));
    ?>
</head>
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <p class="text-muted">Now you are viewing the outlet page</p>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title vertical-center">Outlet Listing</h3>
                                    <a href="input-outlet.php"><button class="btn btn-md btn-light float-right"><i class="fa-solid fa-arrow-up-right-from-square"></i> Add new outlet</button></a>
                                </div>
                                            ...
                                            <?php
                                                ...
                                                while($fetch=mysqli_fetch_array($query)){ 
                                                    ...
                                                    "<tr>
                                                        ...
                                                        <td>".$fetch['alamat']."</td>
                                                        <td>
                                                            <a href='edit-outlet.php?id_outlet=".$fetch['id_outlet']."'><button class='btn btn-xs btn-info' type='button'><i class='fa fa-edit'></i> Edit</button></a> |
                                                            <button class='btn btn-xs btn-danger' type='button' id='btnDel' data-id='".$fetch['id_outlet']."'><i class='fa-regular fa-trash-can'></i> Hapus</button>
                                                        </td>
                                                    </tr>
                                                    ";
                                                    $i++; 
...
<script>
    ...
    tableData.on("click","#btnDel",function(){
        ...
        var btn=$(this);
        var id_outlet=$(this).attr("data-id");
        // alert(id_outlet);
        var promise=$.ajax({
